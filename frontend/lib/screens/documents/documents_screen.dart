...
class DocumentsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final DocumentRepository repository = context.watch<DocumentRepository>();
    final VehicleProvider vehicleProvider = context.watch<VehicleProvider>();

    return FutureBuilder<List<VehicleDocument>>(
      future: repository.getDocuments(),
      builder: (
        ...
        final List<VehicleDocument> documents = snapshot.data ?? <VehicleDocument>[];
        return ListView(
